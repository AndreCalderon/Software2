...
?>
		...
		<h3> COMENTARIO INGRESADO !  GRACIAS </h3>
				...
				$sql_insert = 
				"insert into evaluacion (sintomas , tipoEnfermedad , nombreEnfermedad , comentarios , HISTORIAL_idHISTORIAL) 
				VALUES('$_POST[sintomas]','$_POST[tipoEnfermedad]','$_POST[nombreEnfermedad]','$_POST[comentarioMedico]','$CODIGO' )";  
