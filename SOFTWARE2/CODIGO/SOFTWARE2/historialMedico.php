...
error_reporting(0);
				...
				<h5> INGRESAR CODIGO DE HISTORIAL DEL PACIENTE  </h5>

					<form action='agregarComentarioMedico.php' method='POST'>
						<p>
							<label>CODIGO HISTORIAL</label>
							<input type='text' required='required' name='idHistorialAC'>
				...
				$sql = "SELECT idHistorial,enfermedad,tratamiento,detalle
						from historial
						where idHistorialPaci = '$idHistorial';
						";
